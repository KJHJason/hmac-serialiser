...
namespace HKDFTests
{
    ...
    public class RandomKeyTests : BaseTestClass
    {
        ...
        public void Key1()
        {
            byte[] ikm = Base64Encoder.Decode("CwsLCwsLCwsLCwsLCwsLCwsLCwsLCw==");
            byte[] salt = Base64Encoder.Decode("AAECAwQFBgcICQoLDA==");
            byte[] info = Base64Encoder.Decode("8PHy8/T19vf4+Q==");
            int len = 42;
        ...
        public void Key3()
        {
            byte[] ikm = Base64Encoder.Decode("dGVzdGtleXRoYXRpc3RvdGFsbHlzZWNyZXR0ZXN0a2V5dGhhdGlzdG90YWxseXNlY3JldA==");
            byte[] salt = null;
            byte[] info = null;
            int len = 128;
            var expectedOutputs = new string[] 
        ...
        {
            byte[] ikm = Base64Encoder.Decode("dGVzdGtleXRoYXRpc3RvdGFsbHlzZWNyZXR0ZXN0a2V5dGhhdGlzdG90YWxseXNlY3JldA==");
            byte[] salt = Base64Encoder.Decode("Y3VzdG9tLnNhbHQ=");
            byte[] info = null;
            int len = 128;
            var expectedOutputs = new string[] 
            {
        ...
        public void Key4()
        {
            byte[] ikm = Base64Encoder.Decode("dGVzdGtleXRoYXRpc3RvdGFsbHlzZWNyZXRhbmRzZWN1cmV0ZXN0a2V5dGhhdGlzdG90YWxseXNlY3JldGFuZHNlY3VyZQ==");
            byte[] salt = null;
            byte[] info = null;
            int len = 71;
            var expectedOutputs = new string[] 
